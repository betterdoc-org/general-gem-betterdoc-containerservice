...
Gem::Specification.new do |spec|
  spec.name        = "betterdoc-containerservice"
  spec.version     = File.read(File.expand_path("BETTERDOC_CONTAINERSERVICE_VERSION", __dir__)).strip
  spec.authors     = ["BetterDoc GmbH"]
  spec.email       = ["development@betterdoc.de"]
  spec.homepage    = "http://www.betterdoc.de"
  spec.summary     = "Commonly used elements in our containerservice"
  spec.license     = "MIT"
